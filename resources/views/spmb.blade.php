        ...
        <div class="container">
            <div data-aos="zoom-in" data-aos-delay="100">
                <div class="mt-5 pt-lg-5">
                    ...
                    <h1 class="my-text-heading heading-cursor">SPMB</h1>
    ...
    <section>
        <div class="container">
            <div class="mb-5 text-center position-relative">
                <img class="graphic-10" src="{{ asset('images/graphic/Asset 10.png') }}" alt="">
                <h1 class="fs-1 my-text-dark mb-3">Data Peserta SPMB</h1>
                <p>Isilah formulir berikut dengan data yang benar dan lengkap</p>
            </div>
            <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control rounded-5" id="beratBadan" name="berat"
                                    value="{{ old('berat') }}">
                            </div>

                            <div class="mb-3">
                                <label for="tinggiBadan" class="form-label mb-0 pb-1">Tinggi badan (cm)</label>
                                <input type="number" class="form-control rounded-5" id="tinggiBadan" name="tinggi"
                                    value="{{ old('tinggi') }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select rounded-5 border-start-0" id="jenisKelas" name="jenis_kelas"
                                    required>
                                    <option disabled {{ old('jenis_kelas') ? '' : 'selected' }}>Pilih jenis kelas...
                                    </option>
                                    <option value="intensif" {{ old('jenis_kelas')=='intensif' ? 'selected' : '' }}>
                                        intensif</option>
                                    <option value="bilingual" {{ old('jenis_kelas')=='bilingual' ? 'selected' : '' }}>
                                        bilingual</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="angkatanId" class="form-label mb-0 pb-1">Daftar Angkatan Berapa</label>
                                <select class="form-select rounded-5 border-start-0 custom-select-hover" id="angkatanId"
                                    name="angkatan_id" required>
                                    <option disabled {{ old('angkatan_id') ? '' : 'selected' }}>Pilih angkatan...
                                    </option>
                                    @foreach ($angkatan as $angkatanItem)
                                    <option value="{{ $angkatanItem->id }}" {{ old('angkatan_id')==$angkatanItem->id ?
                                        'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select rounded-5 border-start-0 custom-select-hover"
                                    ...
                                    <option disabled {{ old('asal_pendidikan') ? '' : 'selected' }}>Pilih jenis
                                        pendidikan...</option>
                                    ...
                                    <option value="sps" {{ old('asal_pendidikan')=='sps' ? 'selected' : '' }}>SPS
                                    </option>
                                    <option value="tpa" {{ old('asal_pendidikan')=='tpa' ? 'selected' : '' }}>TPA
                                    </option>
                                    <option value="paud" {{ old('asal_pendidikan')=='paud' ? 'selected' : '' }}>PAUD
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-5" id="namaSekolah" name="nama_sekolah"
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-5" id="noTelpAyah" name="no_telepon_ayah"
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-5" id="pendidikanIbu"
                                    name="pendidikan_ibu" value="{{ old('pendidikan_ibu') }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control rounded-5" id="penghasilanIbu"
                                    name="penghasilan_ibu" value="{{ old('penghasilan_ibu') }}">
                            </div>

                            <div class="mb-3">
                                <label for="alamatIbu" class="form-label mb-0 pb-1">Alamat Ibu</label>
                                <textarea class="form-control rounded-5" id="alamatIbu"
                                    name="alamat_ibu">{{ old('alamat_ibu') }}</textarea>
                            </div>
