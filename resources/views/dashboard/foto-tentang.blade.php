                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/dashboard/tentang-kami/update-foto/{{ $fotoTentangs[0]->id }}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <img src="{{ asset( 'storage/' . $fotoTentangs[0]->foto ) }}" alt=""
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                <h5 class="card-header">Default</h5>
                                <div class="card-body">
                                    <form action="/dashboard/tentang-kami/update-foto/{{ $fotoTentangs[1]->id }}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <img src="{{ asset( 'storage/' . $fotoTentangs[1]->foto ) }}" alt=""
                                            style="width: 100px; height: 100px; object-fit: cover;" class="mb-3">
                                        <div class="mb-3">
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                <h5 class="card-header">Default</h5>
                                <div class="card-body">
                                    <form action="/dashboard/tentang-kami/update-foto/{{ $fotoTentangs[2]->id }}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <img src="{{ asset( 'storage/' . $fotoTentangs[2]->foto ) }}" alt=""
                                            style="width: 100px; height: 100px; object-fit: cover;" class="mb-3">
                                        <div class="mb-3">
