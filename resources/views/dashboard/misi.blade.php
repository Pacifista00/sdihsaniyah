                            ...
                            <div class="modal fade" id="tambahMisi" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('/dashboard/misi-sekolah/insert') }}" method="POST">
                                            @csrf
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @foreach ($misis as $misiItem)
                                    <tr>

                                        <td>{{ $misiItem->judul }}</td>
                                        ...
                                        <td class="mx-0">
                                            <div class="mb-1">
                                                <button class="btn btn-success w-100 py-0 py-md-1 px-3 rounded-pill"
                                                    ...
                                                    data-bs-target="#editMisi{{ $misiItem->id }}">Edit</button>
                                            </div>
                                            <div class="mb-1">
                                                <button class="btn btn-danger w-100 py-0 py-md-1 px-3 rounded-pill"
                                                    style="font-size: 0.75rem;" data-bs-toggle="modal"
                                                    data-bs-target="#hapusMisi{{ $misiItem->id }}">Hapus</button>
                                            </div>
                                        </td>
                                    </tr>
                                    {{-- modal edit start --}}
                                    <div class="modal fade" id="editMisi{{ $misiItem->id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <form action="/dashboard/misi-sekolah/update/{{ $misiItem->id }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                    ...
                                    {{-- modal edit end --}}
                                    {{-- modal hapus start --}}
                                    <div class="modal fade" id="hapusMisi{{ $misiItem->id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <form action="/dashboard/misi-sekolah/delete/{{ $misiItem->id }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal-body">
