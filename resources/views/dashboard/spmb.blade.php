                        ...
                        <div>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                {{-- <button
                                    ...
                                    <i class="menu-icon tf-icons bx bxs-file-pdf me-2"></i>
                                    Export PDF
                                </button> --}}
                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="mx-0">
                                            <div class="mb-1">
                                                <form action="/export/pdf/{{ $pendaftarItem->id }}">
                                                    @csrf
                                                    <button type="submit"
                                                        class="btn btn-info w-100 py-0 py-md-1 px-3 rounded-pill"
                                                        style="font-size: 0.75rem;">Unduh
                                                        Form</button>
                                                </form>
                                            </div>
                                            <div class="mb-1">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel1">Detail Pendaftar
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <h6 style="white-space: pre-line">: {{ $pendaftarItem->nik
                                                                }}</h6>
                                                            <h6 style="white-space: pre-line">: {{ $pendaftarItem->nisn
                                                                }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->nama_lengkap }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->nama_panggilan }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->tempat_lahir }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->tanggal_lahir }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->jenis_kelamin }}</h6>
                                                            <h6 style="white-space: pre-line">: {{ $pendaftarItem->agama
                                                                }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->anak_ke }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->jumlah_saudara }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->bahasa }}</h6>
                                                            <h6 style="white-space: pre-line">: {{ $pendaftarItem->berat
                                                                }} kg</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->tinggi }} cm</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->riwayat_penyakit }}</h6>
                                                            <h6 style="white-space: pre-line">: {{ $pendaftarItem->hobi
                                                                }}</h6>
                                                            <h6 style="white-space: pre-line">: {{ $pendaftarItem->bakat
                                                                }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->alamat }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->jenis_kelas }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->angkatan->angkatan }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->asal_pendidikan }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->nama_sekolah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->alamat_sekolah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->nama_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->nik_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->tempat_lahir_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->tanggal_lahir_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->pendidikan_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->pekerjaan_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->penghasilan_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->alamat_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->no_telepon_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->email_ayah }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->nama_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->nik_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->tempat_lahir_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->tanggal_lahir_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->pendidikan_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->pekerjaan_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->penghasilan_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->alamat_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->no_telepon_ibu }}</h6>
                                                            <h6 style="white-space: pre-line">: {{
                                                                $pendaftarItem->email_ibu }}</h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="/dashboard/pendaftar/update/{{ $pendaftarItem->id }}"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="berkasKK" class="form-label">Berkas
                                                                    KK</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="berkasAkta" class="form-label">Berkas
                                                                    Akta</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="nama_lengkap"
                                                                    class="form-control"
                                                                    placeholder="Masukkan nama_lengkap"
                                                                    name="nama_lengkap"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="nama_panggilan" class="form-label">Nama
                                                                    Panggilan</label>
                                                                <input type="text" id="nama_panggilan"
                                                                    class="form-control"
                                                                    placeholder="Masukkan nama_panggilan"
                                                                    name="nama_panggilan"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <select id="jenis_kelamin" name="jenis_kelamin"
                                                                    ...
                                                                    <option value="laki-laki" {{ $pendaftarItem->
                                                                        jenis_kelamin == 'laki-laki' ? 'selected' : ''
                                                                        }}>Laki-Laki</option>
                                                                    <option value="perempuan" {{ $pendaftarItem->
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <select id="agama" name="agama" class="form-control">
                                                                    ...
                                                                    <option value="islam" {{ $pendaftarItem->agama ==
                                                                        'islam' ? 'selected' : '' }}>Islam</option>
                                                                    <option value="kristen" {{ $pendaftarItem->agama ==
                                                                        'kristen' ? 'selected' : '' }}>Kristen</option>
                                                                    <option value="katolik" {{ $pendaftarItem->agama ==
                                                                        'katolik' ? 'selected' : '' }}>Katolik</option>
                                                                    <option value="hindu" {{ $pendaftarItem->agama ==
                                                                        'hindu' ? 'selected' : '' }}>Hindu</option>
                                                                    <option value="buddha" {{ $pendaftarItem->agama ==
                                                                        'buddha' ? 'selected' : '' }}>Buddha</option>
                                                                    <option value="konghucu" {{ $pendaftarItem->agama ==
                                                                        'konghucu' ? 'selected' : '' }}>Konghucu
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="jumlah_saudara" class="form-label">Jumlah
                                                                    Saudara</label>
                                                                <input type="text" id="jumlah_saudara"
                                                                    class="form-control"
                                                                    placeholder="Masukkan jumlah_saudara"
                                                                    name="jumlah_saudara"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="bahasa" class="form-label">Bahasa Yang
                                                                    digunakan</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="tinggi" class="form-label">Tinggi
                                                                    Badan</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="riwayat_penyakit"
                                                                    class="form-control"
                                                                    placeholder="Masukkan riwayat_penyakit"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <textarea type="text" id="alamat" class="form-control"
                                                                    ...
                                                                    name="alamat">{{ $pendaftarItem->alamat }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="jenis_kelas" class="form-label">Jenis
                                                                    Kelas</label>
                                                                <select id="jenis_kelas" name="jenis_kelas"
                                                                    class="form-control">
                                                                    {{$pendaftarItem->jenis_kelas}}
                                                                    <option value="">-- Pilih Jenis Kelas --</option>
                                                                    <option value="bilingual" {{ $pendaftarItem->
                                                                        jenis_kelas == 'bilingual' ? 'selected' : ''
                                                                        }}>Bilingual</option>
                                                                    <option value="intensif" {{ $pendaftarItem->
                                                                        jenis_kelas == 'intensif' ? 'selected' : ''
                                                                        }}>Intensif</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="asal_pendidikan" class="form-label">Asal
                                                                    Pendidikan</label>
                                                                <select id="asal_pendidikan" name="asal_pendidikan"
                                                                    class="form-control">
                                                                    <option value="">-- Pilih Asal Pendidikan --
                                                                    </option>
                                                                    <option value="tk" {{ $pendaftarItem->
                                                                        asal_pendidikan == 'tk' ? 'selected' : '' }}>TK
                                                                    </option>
                                                                    <option value="kb" {{ $pendaftarItem->
                                                                        asal_pendidikan == 'kb' ? 'selected' : '' }}>KB
                                                                    </option>
                                                                    <option value="ra" {{ $pendaftarItem->
                                                                        asal_pendidikan == 'ra' ? 'selected' : '' }}>RA
                                                                    </option>
                                                                    <option value="sps" {{ $pendaftarItem->
                                                                        asal_pendidikan == 'sps' ? 'selected' : ''
                                                                        }}>SPS</option>
                                                                    <option value="tpa" {{ $pendaftarItem->
                                                                        asal_pendidikan == 'TPA' ? 'selected' : ''
                                                                        }}>TPA</option>
                                                                    <option value="paud" {{ $pendaftarItem->
                                                                        asal_pendidikan == 'PAUD' ? 'selected' : ''
                                                                        }}>PAUD</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="nama_sekolah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan nama_sekolah"
                                                                    name="nama_sekolah"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="alamat_sekolah" class="form-label">Alamat
                                                                    Sekolah</label>
                                                                <input type="text" id="alamat_sekolah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan alamat_sekolah"
                                                                    name="alamat_sekolah"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="nik_ayah" class="form-label">NIK
                                                                    Ayah</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="tempat_lahir_ayah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan tempat_lahir_ayah"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="tanggal_lahir_ayah"
                                                                    class="form-label">Tanggal Lahir Ayah</label>
                                                                <input type="date" id="tanggal_lahir_ayah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan tanggal_lahir_ayah"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="pendidikan_ayah"
                                                                    class="form-label">Pendidikan Ayah</label>
                                                                <input type="text" id="pendidikan_ayah"
                                                                    class="form-control"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="pekerjaan_ayah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan pekerjaan_ayah"
                                                                    name="pekerjaan_ayah"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="penghasilan_ayah"
                                                                    class="form-label">Penghasilan Ayah</label>
                                                                <input type="number" id="penghasilan_ayah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan penghasilan_ayah"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="alamat_ayah" class="form-label">Alamat
                                                                    Ayah</label>
                                                                <textarea type="text" id="alamat_ayah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan alamat_ayah"
                                                                    name="alamat_ayah">{{ $pendaftarItem->alamat_ayah }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="no_telepon_ayah" class="form-label">No
                                                                    Telepon Ayah</label>
                                                                <input type="text" id="no_telepon_ayah"
                                                                    class="form-control"
                                                                    placeholder="Masukkan no_telepon_ayah"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="email_ayah" class="form-label">Alamat
                                                                    Ayah</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="tempat_lahir_ibu"
                                                                    class="form-control"
                                                                    placeholder="Masukkan tempat_lahir_ibu"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="date" id="tanggal_lahir_ibu"
                                                                    class="form-control"
                                                                    placeholder="Masukkan tanggal_lahir_ibu"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="pendidikan_ibu"
                                                                    class="form-control"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                ...
                                                                <input type="text" id="pekerjaan_ibu"
                                                                    class="form-control"
                                                                    placeholder="Masukkan pekerjaan_ibu"
                                                                    name="pekerjaan_ibu"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="penghasilan_ibu"
                                                                    class="form-label">Penghasilan Ibu</label>
                                                                <input type="number" id="penghasilan_ibu"
                                                                    class="form-control"
                                                                    placeholder="Masukkan penghasilan_ibu"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="alamat_ibu" class="form-label">Alamat
                                                                    Ibu</label>
                                                                <textarea type="text" id="alamat_ibu"
                                                                    class="form-control"
                                                                    placeholder="Masukkan alamat_ibu"
                                                                    name="alamat_ibu">{{ $pendaftarItem->alamat_ibu }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="no_telepon_ibu" class="form-label">No
                                                                    Telepon Ibu</label>
                                                                <input type="text" id="no_telepon_ibu"
                                                                    class="form-control"
                                                                    placeholder="Masukkan no_telepon_ibu"
                                                                    name="no_telepon_ibu"
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <label for="email_ibu" class="form-label">Alamat
                                                                    Ibu</label>
