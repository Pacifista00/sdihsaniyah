        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <button class="btn btn-success rounded-pill py-2" data-bs-toggle="modal"
                                data-bs-target="#tambahProgram">Tambah</button>
                            <!-- Modal -->
                            <div class="modal fade" id="tambahProgram" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('/dashboard/program/insert') }}" method="POST"
                    ...
                    <div class="card">
                        <h5 class="card-header">Program Sekolah</h5>
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('storage/' . $programItem->foto) }}"
                                                class="img-table shadow-md" alt="">
                                        </td>
                                        <td>{{ $programItem->judul }}</td>
                                        ...
                                        <td class="mx-0">
                                            <div class="mb-1">
                                                <button class="btn btn-success w-100 py-0 py-md-1 px-3 rounded-pill"
                                                    ...
                                                    data-bs-target="#editProgram{{ $programItem->id }}">Edit</button>
                                            </div>
                                            <div class="mb-1">
                                                <button class="btn btn-danger w-100 py-0 py-md-1 px-3 rounded-pill"
                                                    style="font-size: 0.75rem;" data-bs-toggle="modal"
                                                    data-bs-target="#hapusProgram{{ $programItem->id }}">Hapus</button>
                                            </div>
                                        </td>
                                    </tr>
                                    {{-- modal edit start --}}
                                    <div class="modal fade" id="editProgram{{ $programItem->id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <form action="/dashboard/program/update/{{ $programItem->id }}"
                                    ...
                                    {{-- modal edit end --}}
                                    {{-- modal hapus start --}}
                                    <div class="modal fade" id="hapusProgram{{ $programItem->id }}" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <form action="/dashboard/program/delete/{{ $programItem->id }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="modal-body">
